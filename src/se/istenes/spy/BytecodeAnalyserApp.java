...
//
//import se.istenes.spy.util.Bytecodes;
//import se.istenes.spy.util.ClassFile;
//
///**
// * The main class of the application.
// */
//public class BytecodeAnalyserApp extends SingleFrameApplication {
//
...
//    
//    private static int currentConstantPoolIndex = 1; //Constant pool index starts with 1
//    private static int constantPoolCount;
//    
//    private static int currentInterface = 1; //Constant pool index starts with 1
...
//        show(new BytecodeAnalyserView(this));
//    }
//
//    /**
...
//     * @return the instance of BytecodeAnalyserApp
//     */
//    public static BytecodeAnalyserApp getApplication() {
//        return Application.getInstance(BytecodeAnalyserApp.class);
//    }
//
//    /**
...
//        launch(BytecodeAnalyserApp.class, args);
//    }
//    
//    public static void readClassFile(java.io.File file){
...
//    }
//    
//    public static boolean readBytecodes(java.io.File file){
//        
//        
...
//                if(!isCafeBabeFound){
//                    isCafeBabeFound = 
//                            classFile.read()==Bytecodes.CA ?
//                            classFile.read()==Bytecodes.FE ?
//                            classFile.read()==Bytecodes.BA ?
//                            classFile.read()==Bytecodes.BE ? true :false :false :false :false;
//                    if(isCafeBabeFound)
//                        cafeBabeFound();
//                    else {
//                        BytecodeAnalyserView.printBytecode("0xCAFEBABE: Not found!\nAre you sure this is a .class file?");    
//                        return false;
//                    }
//                } else {
//                    switch(currentByte){
//                        case 4:
//                            int[] version = new int[2]; //two bytes for minor version
...
//                            
//                        case 6:
//                            int[] majorVersion = new int[2]; //two bytes for minor version
//                            majorVersion[0] = classFile.read();
//                            majorVersion[1] = classFile.read();
//                            majorVersion(majorVersion);
//                        break; 
//                        case 8:
//                            int[] constantPoolCountData = new int[2]; //two bytes for minor version
...
//                                return false;
//                            }
//                            BytecodeAnalyserView.printBytecode("Unkown bytecode: " + code);
//                            lastByte = code;  
//                        break;
//                    }
//                     
...
//    }
//    
//    private static void minorVersion(int[] byteData){
//        BytecodeAnalyserView.printBytecode("minor_version: "+byteData[0]+"."+byteData[1]);
//        currentByte = 6;
//    }
//    
//    private static void majorVersion(int[] byteData){
//        //The first byte (version[0]) is unused... I think...
//        BytecodeAnalyserView.printBytecode("major_version: "+Bytecodes.MajorVersion.getVersionName(byteData[1]));
//        currentByte = 8;
//    }
//    
//    private static void constantPoolCount(int[] byteData){
//        //Sets the constantpool count, remembet that we need to subtract this with one when we use it.
//        constantPoolCount = byteData[0]+byteData[1];
//        BytecodeAnalyserView.printBytecode("constant_pool_count: "+constantPoolCount);
//        currentByte = 10;
//    }
//    
...
//        
//        
//        BytecodeAnalyserView.printBytecode("\nConstant Pool\n======================");
//        try {
//            for(int i = 1; i<constantPoolCount; i++) {
//                final int bytecode = bytecodes.read();
//                Bytecodes.ConstantType constantType = Bytecodes.ConstantType.getConstantType(bytecode);
//                currentByte += 1;
//                int classIndex;
...
//                        
//                        BytecodeAnalyserView.printField(constantType.constantTypeName() + " {\n\tconstant_pool_index: "+currentConstantPoolIndex+"\n\tlength: "+length+"\n\tbytes_as_text: "+text+"\n}");
//                    break;
//                        
//                    case CONSTANT_Integer:
//                        bytes = new byte[4];
//                        bytecodes.read(bytes, 0, 4);
//                        int integerValue = ((0xFF & bytes[0]) << 24) | ((0xFF & bytes[1]) << 16) |
...
//                        bytes = new byte[4];
//                        bytecodes.read(bytes, 0, 4);
//                        float floatValue = Float.intBitsToFloat(((0xFF & bytes[0]) << 24) | ((0xFF & bytes[1]) << 16) | ((0xFF & bytes[2]) << 8) | (0xFF & bytes[3]));
//                        BytecodeAnalyserView.printField(constantType.constantTypeName() + " {\n\tconstant_pool_index: "+currentConstantPoolIndex+"\n\tfloat: "+floatValue+"\n}");
//                    break;
//                        
//                    case CONSTANT_Long:   
...
//                        int highLong = ((0xFF & bytes[0]) << 24) | ((0xFF & bytes[1]) << 16) |
//                        ((0xFF & bytes[2]) << 8) | (0xFF & bytes[3]);                        
//                        int lowLong = ((0xFF & bytes[4]) << 24) | ((0xFF & bytes[5]) << 16) |
//                        ((0xFF & bytes[6]) << 8) | (0xFF & bytes[7]);
//                        BytecodeAnalyserView.printField(constantType.constantTypeName() + " {\n\tconstant_pool_index: "+currentConstantPoolIndex+"\n\tlong: "+highLong+lowLong+"\n}");
//                    break;
//                        
...
//                        bytes = new byte[8];
//                        bytecodes.read(bytes, 0, 8);
//                        int highDouble = ((0xFF & bytes[0]) << 24) | ((0xFF & bytes[1]) << 16) |
//                        ((0xFF & bytes[2]) << 8) | (0xFF & bytes[3]);                        
//                        int lowDouble = ((0xFF & bytes[4]) << 24) | ((0xFF & bytes[5]) << 16) |
//                        ((0xFF & bytes[6]) << 8) | (0xFF & bytes[7]);
//                        BytecodeAnalyserView.printField(constantType.constantTypeName() + " {\n\tconstant_pool_index: "+currentConstantPoolIndex+"\n\tlong: "+highDouble+"."+lowDouble+"\n}");
//                    break;
//                        
//                    case CONSTANT_Class:
//                        bytes = new byte[2];
...
//                        BytecodeAnalyserView.printBytecode("Unkown Constant Type: "+bytecode);
//                    break;
//                }
//                
...
//        BytecodeAnalyserView.printBytecode("interface_count: "+interfaceCount);
//        
//        for(int i = 0;i<interfaceCount;i++){
//            bytes = new byte[2];
//            bytecodes.read(bytes, 0, 2);
//            int interface_index = u2(bytes);
//            BytecodeAnalyserView.printBytecode("interface_index: "+interface_index);
//        }
//        
//        
//        BytecodeAnalyserView.printBytecode("\nFields\n======================");        
...
//                 * index must be a CONSTANT_Utf8_info (§4.4.7) structure representing 
...
//        BytecodeAnalyserView.printBytecode("methods_count: "+methods_count);
//        
...
//            int attributes_count = u2(bytes);
//            
//            //If method_info is Native or Abstract, it must NOT contain any Code Attributes.
...
//        
//        isPublic = (acces_flags & Bytecodes.AccesFlag.ACC_PUBLIC.flagBit()) ==  Bytecodes.AccesFlag.ACC_PUBLIC.flagBit() ? true : false;
//        isFinal = (acces_flags & Bytecodes.AccesFlag.ACC_FINAL.flagBit()) ==  Bytecodes.AccesFlag.ACC_FINAL.flagBit() ? true : false;
//        isSuper = (acces_flags & Bytecodes.AccesFlag.ACC_SUPER.flagBit()) ==  Bytecodes.AccesFlag.ACC_SUPER.flagBit() ? true : false;
//        isInterface = (acces_flags & Bytecodes.AccesFlag.ACC_INTERFACE.flagBit()) ==  Bytecodes.AccesFlag.ACC_INTERFACE.flagBit() ? true : false;
//        isAbstract = (acces_flags & Bytecodes.AccesFlag.ACC_ABSTRACT.flagBit()) ==  Bytecodes.AccesFlag.ACC_ABSTRACT.flagBit() ? true : false;
//        
...
//                                            Bytecodes.AccesFlag.ACC_STATIC,
//                                            Bytecodes.AccesFlag.ACC_FINAL,
//                                            Bytecodes.AccesFlag.ACC_VOLATILE,
//                                            Bytecodes.AccesFlag.ACC_TRANSIENT };
//        
//        for(int i = 0; i<acces_flags.length;i++){
//            acces_flags[i].isSet = (bytes & acces_flags[i].flagBit()) ==  acces_flags[i].flagBit() ? true : false;
//        }
//        
//        return acces_flags;
//    }
